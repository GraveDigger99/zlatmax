(() => {
    ...
    (() => {
                    ...
                    itemTotal.addEventListener("keydown", (function(e) {
                        ...
                        switch (e.which) {
                          ...
                          case 38:
                            position = step[1];
                            if (false === position) position = 1;
                            if (null !== position) itemTotal.noUiSlider.setHandle(handle, value + position);
                            break;
                    ...
                    itemLenght.addEventListener("keydown", (function(e) {
                        ...
                        switch (e.which) {
                          ...
                          case 38:
                            position = step[1];
                            if (false === position) position = 1;
                            if (null !== position) itemLenght.noUiSlider.setHandle(handle, value + position);
                            break;
                    ...
                    itemWidth.addEventListener("keydown", (function(e) {
                        ...
                        switch (e.which) {
                          ...
                          case 38:
                            position = step[1];
                            if (false === position) position = 1;
                            if (null !== position) itemWidth.noUiSlider.setHandle(handle, value + position);
                            break;
        ...
        const subMenuBlocks = document.querySelectorAll(".sub-menu-catalog__block");
        if (subMenuBlocks.length) subMenuBlocks.forEach((subMenuBlock => {
            const subMenuBlockItems = subMenuBlock.querySelectorAll(".sub-menu-catalog__category").length;
            subMenuBlock.classList.add(`sub-menu-catalog__block_${subMenuBlockItems}`);
        }));
        function documentActions(e) {
            ...
            if (targetElement.closest("[data-parent]")) {
                ...
                } else console.log("bele alt menu yoxdur");
                e.preventDefault();
            }
